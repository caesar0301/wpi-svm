...
parser.add_argument('original_file', type=str, help= 'original instance file')
parser.add_argument('selected_file', type=str, help= 'instance file with selected features')
args = parser.parse_args()
fnum = args.flist
ori = args.original_file
sel = args.selected_file
sn_arr = fnum.split(',')
sns = set()
for sn in sn_arr:
    if '-' in sn:
...
cmd = '{0} {1}'.format(checkdata_py, ori)
